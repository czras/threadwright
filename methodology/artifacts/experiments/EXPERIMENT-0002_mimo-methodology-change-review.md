...
2. **HEURISTIC-0009 numbering inconsistency**
    - Ten scenarios referenced the heuristic as H9 (now [HEURISTIC-0009](../heuristics/HEURISTIC-0009_generate-broadly-compress-deliberately.md)) while two did not.
    - MiMo also identified the absence of H5–H8 (now [HEURISTIC-0005](../heuristics/HEURISTIC-0005_choose-knowledge-action.md) through [HEURISTIC-0008](../heuristics/HEURISTIC-0008_epistemic-integrity.md)) and the lack of an index entry.
...
- heuristic → [Generate Broadly, Compress Deliberately](../../principles.md#generate-broadly-compress-deliberately) principle;
- heuristic → existing invariants;
- heuristic → [threadwright.md §6](../../threadwright.md#6-consequential-gaps-and-useful-activity);
- principle → heuristic;
- heuristic → scenarios;
- scenarios → heuristic;
- scenarios → [`threadwright.md`](../../threadwright.md);
