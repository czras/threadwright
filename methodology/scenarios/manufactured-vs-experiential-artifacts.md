# Scenario — Manufactured vs Experiential Knowledge in Artifacts
...
**Step 2 — Apply epistemic integrity (I3) during reassessment**
...
Options:
  ...
  - Run chaos test on prototype (experiential, 3 days)
    ↓
I5 choice: Jepsen reports first (cheapest manufactured knowledge)
```
...
Options:
  ...
  - Canary deploy 1% traffic (experiential, 1 week)
    ↓
I5 choice: Load test first (manufactured model won't capture real contention)
```

## Demonstrates

- Artifacts explicitly tagged with epistemic origin (manufactured vs experiential)
- I3 Epistemic Integrity prevents treating vendor claims as equivalent to prototype evidence
- Reassessment weighs evidence by origin and confidence
- Remaining gaps categorized by which mode can resolve them
- I5 Optimization selects origin-appropriate next actions
...
- [ ] Next actions selected using I5 with origin awareness
...
- [threadwright.md §5, 7, 8](../threadwright.md) — Artifact system, decisions/evidence, I3 Epistemic Integrity
- [choose-knowledge-action.md](../heuristics/choose-knowledge-action.md)
- [ASSESSMENT-0008 §5, 6](artifacts/ASSESSMENT-0008_manufactured-vs-evolved.md#5-emerging-central-formulation)
- [ASSESSMENT-0009 §5](artifacts/ASSESSMENT-0009_assessment-of-ASSESSMENT-0008.md#5-manufactured-and-evolved-knowledge)