# SCENARIO-0007 — Evolving Intent from Messy Input
...
**Step 6 — Select knowledge-generating actions (INVARIANT-0005 Optimization)**
```
...
- INVARIANT-0005 Optimization selects cheapest knowledge-generating action (log analysis vs. building caching)
...
- [ ] Action selection uses INVARIANT-0005 Optimization (manufactured vs experiential compared)
- [ ] Intent evolution recorded with evidence trail
- [ ] Final intent differs from proposed solution in input

## References

- [threadwright.md §3, 4, 6, 8](../threadwright.md) — Intent, control loop, consequential gaps, INVARIANT-0005
- [HEURISTIC-0007_evolve-intent-from-messy-input](../heuristics/HEURISTIC-0007_evolve-intent-from-messy-input.md)
- [HEURISTIC-0005_choose-knowledge-action](../heuristics/HEURISTIC-0005_choose-knowledge-action.md)
- [ASSESSMENT-0009_assessment-of-ASSESSMENT-0008 §4](../artifacts/assessments/ASSESSMENT-0009_assessment-of-ASSESSMENT-0008.md#4-messy-input-and-evolving-intent)
- [ASSESSMENT-0003_input-scrutiny-and-extraction](../artifacts/assessments/ASSESSMENT-0003_input-scrutiny-and-extraction.md)