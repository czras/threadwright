# SCENARIO-0008 — Recursive Self-Application
...
- "INVARIANT-0005 Optimization invariant rarely used explicitly"
...
Gap 2: "INVARIANT-0005 Optimization not operationalized — no shared mental model"
...
- Create decision log template forcing manufactured/experiential choice (manufactured)
    ↓
INVARIANT-0005 choice: Add boundary check to template (lowest cost, directly addresses gap)
```
...
- Pair on next 3 Changes using INVARIANT-0005 explicitly (experiential)
- Build simple calculator tool (manufactured + tooling)
    ↓
INVARIANT-0005 choice: Pair on next 3 Changes (experiential learning sticks better than docs)
```
...
- Archive completed Changes (manufactured)
    ↓
INVARIANT-0005 choice: Add "gap relevance" tag + archive (manufactured, scalable)
```
...
- INVARIANT-0005 language used naturally in standups
...
- INVARIANT-0005 Optimization added to team's working agreements
...
- INVARIANT-0005 Optimization used to choose *how to improve the methodology*
...
- [ ] INVARIANT-0005 Optimization used to select methodology improvement actions
...
- [HEURISTIC-0004_reassess](../heuristics/HEURISTIC-0004_reassess.md) — Reassessment drives evolution
...
- [ASSESSMENT-0008_manufactured-vs-evolved §13](../artifacts/assessments/ASSESSMENT-0008_manufactured-vs-evolved.md#13-recursive-learning-about-learning)