# Heuristic: Choose Knowledge-Generating Action
...
- Facing a consequential gap (see [address-consequential-gaps.md](address-consequential-gaps.md))
...
5. **Check boundary conditions**:
   ...
   - Are we preserving alternatives when evidence is weak? (see [preserve-alternatives.md](preserve-alternatives.md) — future heuristic)
...
- [dynamic-think-experience-boundary.md](dynamic-think-experience-boundary.md) — Recognizing when the boundary shifts
- [address-consequential-gaps.md](address-consequential-gaps.md) — Identifying what gaps matter
- [reassess.md](reassess.md) — Re-evaluating after action produces evidence

## Related Scenarios

- [Optimization Invariant (I5) Stress Test](../scenarios/optimization-invariant-i5.md) — Full worked example of action sequencing
- [Dynamic Think/Experience Boundary Shift](../scenarios/dynamic-think-experience-boundary.md) — Boundary shifts across phases
- [Manufactured vs Experiential Knowledge in Artifacts](../scenarios/manufactured-vs-experiential-artifacts.md) — Origin-aware action selection
- [Evolving Intent from Messy Input](../scenarios/evolve-intent-from-messy-input.md) — Log analysis (manufactured) vs building (experiential)

## References

- [ASSESSMENT-0008 §5-7](artifacts/ASSESSMENT-0008_manufactured-vs-evolved.md#5-emerging-central-formulation) — Central formulation, knowledge-generating actions, cost of learning
- [ASSESSMENT-0009 §5, 8](artifacts/ASSESSMENT-0009_assessment-of-ASSESSMENT-0008.md#5-manufactured-and-evolved-knowledge) — Manufactured vs experiential, cost of learning
