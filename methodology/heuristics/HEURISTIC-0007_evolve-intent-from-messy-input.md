# HEURISTIC-0007 — Evolve Intent from Messy Input
...
Input comes in many forms — see [ASSESSMENT-0009_assessment-of-ASSESSMENT-0008 §4](../artifacts/assessments/ASSESSMENT-0009_assessment-of-ASSESSMENT-0008.md#4-messy-input-and-evolving-intent):
...
This is the Threadwright control loop — see [threadwright.md §4](../threadwright.md#4-control-loop) and [ASSESSMENT-0009_assessment-of-ASSESSMENT-0008 §4](../artifacts/assessments/ASSESSMENT-0009_assessment-of-ASSESSMENT-0008.md#4-messy-input-and-evolving-intent).
...
Low proportionality → lightweight clarification. High proportionality → structured scrutiny (see [ASSESSMENT-0003_input-scrutiny-and-extraction](../artifacts/assessments/ASSESSMENT-0003_input-scrutiny-and-extraction.md)).
...
Focus scrutiny on ambiguities that are consequential — see [HEURISTIC-0001_address-consequential-gaps](HEURISTIC-0001_address-consequential-gaps.md).
...
Use [HEURISTIC-0005_choose-knowledge-action](HEURISTIC-0005_choose-knowledge-action.md) to pick actions that reduce the most consequential gaps per cost.
...
When evidence is weak and consequences of being wrong are high, preserve alternative intent candidates — see [ASSESSMENT-0009_assessment-of-ASSESSMENT-0008 §4](../artifacts/assessments/ASSESSMENT-0009_assessment-of-ASSESSMENT-0008.md#4-messy-input-and-evolving-intent) and [RESEARCH-0000_evolutionary-computation §7](../artifacts/research/RESEARCH-0000_evolutionary-computation.md#7-diversity-and-premature-convergence).
...
- [HEURISTIC-0001_address-consequential-gaps](HEURISTIC-0001_address-consequential-gaps.md) — Identifying what gaps matter for intent
- [HEURISTIC-0005_choose-knowledge-action](HEURISTIC-0005_choose-knowledge-action.md) — Selecting actions to evolve intent
- [HEURISTIC-0004_reassess](HEURISTIC-0004_reassess.md) — Re-evaluating intent after evidence

## Related Scenarios

- [SCENARIO-0007_evolve-intent-from-messy-input](../scenarios/SCENARIO-0007_evolve-intent-from-messy-input.md) — Full worked example
- [SCENARIO-0003_when-request-is-not-intent](../scenarios/SCENARIO-0003_when-request-is-not-intent.md) — Related scenario
- [SCENARIO-0001_greenfield-product-idea](../scenarios/SCENARIO-0001_greenfield-product-idea.md) — Starting from idea

## References

- [ASSESSMENT-0009_assessment-of-ASSESSMENT-0008 §4](../artifacts/assessments/ASSESSMENT-0009_assessment-of-ASSESSMENT-0008.md#4-messy-input-and-evolving-intent) — Messy input and evolving intent
- [ASSESSMENT-0003_input-scrutiny-and-extraction](../artifacts/assessments/ASSESSMENT-0003_input-scrutiny-and-extraction.md) — Input scrutiny framework
- [ASSESSMENT-0004_establishing-intent-from-input](../artifacts/assessments/ASSESSMENT-0004_establishing-intent-from-input.md) — Establishing intent from input
