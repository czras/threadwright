# HEURISTIC-0009 — Generate Broadly, Compress Deliberately
...
- [SCENARIO-0019_cheap-generation-expensive-evaluation](../scenarios/SCENARIO-0019_cheap-generation-expensive-evaluation.md) — Total cost, irreversible evaluation, expensive generation
- [SCENARIO-0018_engineering-design](../scenarios/SCENARIO-0018_engineering-design.md) — Multiple candidate designs and implementations
- [SCENARIO-0020_knowledge-connections](../scenarios/SCENARIO-0020_knowledge-connections.md) — Latent relationship discovery
- [SCENARIO-0021_ambiguous-interpretation](../scenarios/SCENARIO-0021_ambiguous-interpretation.md) — Premature convergence prevention
- [SCENARIO-0022_over-compression](../scenarios/SCENARIO-0022_over-compression.md) — Compactness as proxy trap
...
- [threadwright.md §8 INVARIANT-0005](../threadwright.md#invarient-0005--optimization) — Optimization invariant
...
- [HEURISTIC-0008 — Epistemic Integrity](../heuristics/HEURISTIC-0008_epistemic-integrity.md) — Distinguishing generated hypotheses from established knowledge